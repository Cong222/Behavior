  ...
  ePieChartDataModel:(EPieChartDataModel *)ePieChartDataModel
{
    ...
    if (self)
    {
        ...
        currentLabel.format = @"平均值:%.0f";
        [_contentView addSubview:currentLabel];
        [currentLabel countFrom:0 to:_ePieChartDataModel.budget withDuration:2.0f];
...
- (void)setEPieChartDataModel:(EPieChartDataModel *)ePieChartDataModel {
    _ePieChartDataModel = ePieChartDataModel;
    ...
    currentLabel.format = @"平均值:%.0f";
    [_contentView addSubview:currentLabel];
    [currentLabel countFrom:0 to:_ePieChartDataModel.estimate withDuration:2.0f];
    ...
    estimateLabel.format = @"预测:%.0f";
    [_contentView addSubview:estimateLabel];
    [estimateLabel countFrom:0 to:_ePieChartDataModel.budget withDuration:2.0f];
